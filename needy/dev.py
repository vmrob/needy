    ...
    with ConfiguredNeedy('.', parameters) as needy:
        ...
        if parameters.library:
            if parameters.library in library_names:
                logging.info('{} is in dev mode: {}'.format(parameters.library, needy.source_directory(parameters.library)))
                return 0
            else:
        ...
        if library_names:
            ...
            for name in library_names:
                print('  {}{:{}} {}'.format(name, '', max_name_length - len(name) + 1, needy.source_directory(name)))
            print('')
